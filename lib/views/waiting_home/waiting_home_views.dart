...
class WaitingHomeViews extends StatelessWidget {
  const WaitingHomeViews({super.key, required this.state, required this.index});
  ...
  Widget build(BuildContext context) {
    ...
    final filteredTodos =
        state.where((task) => task.status.toLowerCase() == 'waiting').toList();
    return Padding(
